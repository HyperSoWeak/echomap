...
export const DEMO_CONCEPT_GRAPH: ConceptGraph = {
  nodes: [
    { id: "ai-model", title: "人工智慧模型", status: "learned", x: 16, y: 25 },
    { id: "llm", title: "大型語言模型", status: "learned", x: 40, y: 25 },
    { id: "ai-agent", title: "AI Agent", status: "current", x: 64, y: 25 },
    { id: "agent-loop", title: "Agent 循環", status: "locked", x: 88, y: 25 },
    { id: "goal-clarification", title: "目標澄清", status: "locked", x: 16, y: 72 },
    { id: "tool-selection", title: "工具選擇", status: "locked", x: 40, y: 72 },
    { id: "prompt-injection-risk", title: "提示注入風險", status: "locked", x: 64, y: 72 },
    { id: "agent-workflow", title: "完整工作流程", status: "locked", x: 88, y: 72 },
  ],
  edges: [
    ["ai-model", "llm"],
    ["llm", "ai-agent"],
    ...
    ["goal-clarification", "tool-selection"],
    ["tool-selection", "agent-workflow"],
